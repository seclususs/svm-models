...
def plot_precision_recall_curve(y_true, y_pred_proba):
    """
    Menghitung dan memplot Kurva Precision-Recall untuk setiap kelas (One-vs-Rest)
    dan menyimpan plot sebagai file gambar.
    ...
    try:
        ...
        # Hitung kurva Precision-Recall dan AP untuk setiap kelas
